...
public class VatConditionModel {
	...
	public VatConditionModel(Integer id, String name, Boolean isDeleted, LocalDateTime createdAt,
	...
	public String toString() {
		return "VatConditionModel [id=" + id + ", name=" + name + ", isDeleted=" + isDeleted + ", createdAt="
