...
VALUES 
  (
    ...
    175, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Calle Independencia', '234', '5000', 
    'Córdoba', 176, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. Santa Fe', '789', '3000', 'Rosario', 
    191, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. San Martín', '123', '5500', 
    'Mendoza', 183, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. 9 de Julio', '567', '4000', 'San Miguel de Tucumán', 
    194, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. Belgrano', '890', '4400', 'Salta', 
    187, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. Argentina', '321', '8300', 'Neuquén', 
    185, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Calle Rivadavia', '654', '9000', 
    'Comodoro Rivadavia', 174, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. Urquiza', '987', '3100', 'Paraná', 
    178, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Calle Alvear', '210', '4600', 'San Salvador de Jujuy', 
    180, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Av. Pueyrredón', '123', '1425', 
    'CABA', 175, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
  ...
  (
    ...
    'Paraná', 178, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
...
VALUES 
  ('Masculino', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Femenino', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
...
VALUES 
  (
    ...
    '123456789', 1, 1, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Ana', 'Martínez', '987654328', 'ana.martinez@gmail.com', 
    '987654321', 2, 2, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Carlos', 'López', '567890122', 'claudio.lopez@outlook.com', 
    '567890123', 1, 3, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'María', 'Rodríguez', '345678901', 
    'maria.rodriguez@gmail.com', '345678901', 
    2, 4, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Diego', 'Sánchez', '876543213', 
    'diego.sanchez@gmail.com', '876543210', 
    3, 5, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Laura', 'Fernández', '234567894', 
    'laura.fernandez@outlook.com', 
    '234567890', 2, 6, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Pedro', 'García', '789012345', 'pedro.garcia@hotmail.com', 
    '789012345', 1, 7, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Sofía', 'Pérez', '456789016', 'sofia.perez@gmail.com', 
    '456789012', 2, 8, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Pablo', 'Hernández', '123890767', 
    'pablo.hernandez@yahoo.com', '123890765', 
    1, 9, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Marta', 'Díaz', '908712348', 'marta.diaz@gmail.com', 
    '908712345', 2, 10, 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ),
  (
    'admin', 'admin', '000000000', 'admin@asjservicios.com', 
    '123456789', 1, 21, 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  );

INSERT INTO user_credentials (user_id, password, is_deleted, created_at, updated_at) 
VALUES 
  (
    1, '$2a$12$7GXFLr4yQ9y22ge5u8FpLOQAK2mcMvzlJFkZlCp5Vlmzvf4xrHwJy', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    2, '$2a$12$J7RU5dTKJh/fcRrXOO06UeJb7ar2dFQ1E0KXyltx9msd7fC2aXZ3W', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    3, '$2a$12$TQApwTDX3US3pf0h0D8qCuZ4uljbUuzot2Y2Z2PS8YlMpccduLw1e', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    4, '$2a$12$Fg9jBDEjAZKX4F4OY9Vq0OKOFbHjTFotSpvTb5cNAlqZbUeBJS8FS', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    5, '$2a$12$RPWeel8EJRQIXVig0e/AQOYqOD.Ln6S3rf6ZxjWlNL0pfZsZZr98q', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    6, '$2a$12$l2rRW2iaIAYzP6OXcJWt5ePnmGUMTQbE9jVq9.ZllBxUde7cGH8fy', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    7, '$2a$12$OcTZ5X7HrH6bwG.Sb5dkLe9o7W5zgBEbzzF3RwSNCOVktU02ioNjK', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    8, '$2a$12$NZcm8h9sA3sFE0yMTfNe.uGvEetziYI9TQF94yA6DeODNSRBSwt0y', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    9, '$2a$12$.XmJb.ZlUeZr1ptvl.wn2.Ka8DTwqGZLYYzvMjpv1LbemJDCg6D/i', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    10, '$2a$12$KSa/4xwufTK1x9MF52vTbOqZnMjj2.QTRmouzGEojvC6YDwKo/fPK', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ),
  (
    11, '$2a$10$7vlCB2EB/Ikyvc2Qvp3gDOCVFB9syWz11Tfj7lsRTvQ0SGTkWShcG', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  );

-- Suppliers
INSERT INTO industries (name, is_deleted, created_at, updated_at) 
VALUES 
  ('Tecnología', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Hogar y Muebles', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Herramientas', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Electrodomésticos', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Moda', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Deportes y Fitness', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Salud y Belleza', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Juguetes y Bebés', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Libros', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Otros', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO vat_conditions (name, is_deleted, created_at, updated_at) 
VALUES 
  ('IVA Responsable Inscripto', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('IVA Responsable no Inscripto', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('IVA no Responsable', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('IVA Sujeto Exento', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Consumidor Final', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Responsable Monotributo', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Sujeto no Categorizado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Proveedor del Exterior', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Cliente del Exterior', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (
    'IVA Liberado - Ley Nº 19.640', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'IVA Responsable Inscripto - Agente de Percepción', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Pequeño Contribuyente Eventual', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  ('Monotributista Social', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (
    'Pequeño Contribuyente Eventual Social', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  );

INSERT INTO tax_information (cuit, vat_condition_id, is_deleted, created_at, updated_at) 
VALUES 
  ('45-67890123-4', 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('56-78901234-5', 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('67-89012345-6', 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('78-90123456-7', 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('89-01234567-8', 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('90-12345678-9', 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('01-23456789-0', 6, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('12-34567890-1', 6, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('23-45678901-2', 1, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('34-56789012-3', 2, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES 
  (
    ...
    'luis.fernandez@gmail.com', 'Gerente', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'María', 'Martínez', '+54 456789012', 
    'maria.martinez@gmail.com', 'Supervisor', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Carlos', 'Gómez', '+54 567890123', 'carlos.gomez@hotmail.com', 
    'Empleado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Laura', 'Rodríguez', '+54 678901234', 
    'laura.rodriguez@yahoo.com', 'Empleado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Diego', 'Sánchez', '+54 789012345', 
    'diego.sanchez@gmail.com', 'Empleado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Ana', 'Fernández', '+54 890123456', 
    'ana.fernandez@outlook.com', 'Gerente', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Sofía', 'García', '+54 901234567', 
    'sofia.garcia@gmail.com', 'Asistente', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Pablo', 'Pérez', '+54 012345678', 'pablo.perez@gmail.com', 
    'Supervisor', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
    'Marta', 'Hernández', '+54 123456789', 
    'marta.hernandez@gmail.com', 'Empleado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
  ), 
  (
...
VALUES 
  ('En Proceso', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('En Camino', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Entregado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  ('Cancelado', FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES 
  (1, 1, 3, 159999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (1, 2, 2, 18999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (2, 3, 1, 255999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (2, 4, 4, 112999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (3, 5, 2, 78999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (3, 6, 1, 20999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (4, 7, 3, 588999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (4, 8, 2, 808999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (5, 9, 5, 59900.00, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (5, 10, 1, 108499.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (6, 11, 2, 19999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (6, 12, 3, 314600.00, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (7, 13, 4, 36100.00, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (7, 14, 1, 34998.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (8, 15, 3, 2999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (8, 16, 2, 227999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (9, 17, 1, 29999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (9, 18, 2, 21870.00, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (10, 19, 3, 196549.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), 
  (10, 20, 2, 314999.99, FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
